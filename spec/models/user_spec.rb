...
#RSpec.describe 'users_model', type: :model do
  #describe 'バリデーションテスト' do
    ...
    #context '自己紹介が500文字以上の場合' do
      #it 'バリデーションが作動する' do
        #user = User.new(name: 'aaa', email: 'abc@example.com', password: 'testdayo', #description:'#aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
        #expect(user).not_to be_valid
      #end
    #end
